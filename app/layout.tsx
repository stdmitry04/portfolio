...
export const metadata: Metadata = {
  ...
  description:
    "Backend and AI engineer specializing in production RAG pipelines, tool-calling agents with memory, and multi-tenant AWS infrastructure. Shipped an ERP platform for K12 schools and an AI-powered admissions and career platform embedded with 5 university partners across the US and India.",
  keywords: [
    "Dmitry Starodubtsev",
  ...
  openGraph: {
    ...
    title: "Dmitry Starodubtsev — Backend & AI Engineer",
    description:
      "Backend and AI engineer specializing in production RAG pipelines, tool-calling agents with memory, and multi-tenant AWS infrastructure. Shipped an ERP platform for K12 schools and an AI-powered admissions and career platform embedded with 5 university partners.",
  },
  twitter: {
